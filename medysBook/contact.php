    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8">
          ...
          <div class="mc-contact-info-box"><div class="mc-contact-icon-wrap"><i class="bi bi-clock-fill"></i></div><div><h6 class="fw-bold mb-1">Business Hours</h6><p class="mc-body-text mb-0">Monday – Saturday: 8:00 AM – 5:00 PM<br>Sunday: By appointment only</p></div></div>
          <div class="mc-contact-info-box"><div class="mc-contact-icon-wrap"><i class="bi bi-credit-card-fill"></i></div><div><h6 class="fw-bold mb-1">Payment Methods</h6><p class="mc-body-text mb-0">We accept Cash, Bank Transfer, and GCash.</p></div></div>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-8">
          <div class="accordion" id="faqAccordion">
            <div class="accordion-item border-0 mb-3 rounded-3 overflow-hidden shadow-sm"><h2 class="accordion-header"><button class="accordion-button fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#faq1">How do I book an event with Medy's Catering?</button></h2><div id="faq1" class="accordion-collapse collapse show" data-bs-parent="#faqAccordion"><div class="accordion-body mc-body-text">You can book through our online booking form on this website, call us at <strong>0999 864 8368</strong>, email us at <strong>mdavesulabo@yahoo.com</strong>, or send us a message on Facebook. Once we receive your request, our team will contact you within <strong>24 hours</strong> to confirm availability.</div></div></div>
            <div class="accordion-item border-0 mb-3 rounded-3 overflow-hidden shadow-sm"><h2 class="accordion-header"><button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#faq2">How far in advance should I book?</button></h2><div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion"><div class="accordion-body mc-body-text">Our minimum booking lead times are: <strong>3 days</strong> for standard events, <strong>7 days (1 week)</strong> for events with 150 or more guests, and <strong>2 days</strong> for Food Only (catering-only) orders. We also accommodate a maximum of <strong>2 bookings per day</strong>, so we recommend booking as early as possible.</div></div></div>
            <div class="accordion-item border-0 mb-3 rounded-3 overflow-hidden shadow-sm"><h2 class="accordion-header"><button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#faq3">What packages do you offer?</button></h2><div id="faq3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion"><div class="accordion-body mc-body-text">We offer three main packages: <strong>Package A</strong> at ₱550/plate, <strong>Package B</strong> at ₱600/plate, and <strong>Package C</strong> at ₱700/plate. We also offer <strong>Food Only</strong> (catering-only) and a <strong>Custom Package</strong> for those who want a tailored setup. Each package includes different menu selections and add-on options — visit our <a href="services.php" style="color:var(--mc-red);font-weight:700;">Services page</a> for the full details.</div></div></div>
            <div class="accordion-item border-0 mb-3 rounded-3 overflow-hidden shadow-sm"><h2 class="accordion-header"><button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#faq4">What is your cancellation policy?</button></h2><div id="faq4" class="accordion-collapse collapse" data-bs-parent="#faqAccordion"><div class="accordion-body mc-body-text">Cancellations must be requested at least <strong>7 days</strong> before the event date. Bookings whose event date has already passed are automatically cancelled by the system. For cancellation requests or concerns, please contact us directly at <strong>0999 864 8368</strong> or <strong>mdavesulabo@yahoo.com</strong>.</div></div></div>
            <div class="accordion-item border-0 mb-3 rounded-3 overflow-hidden shadow-sm"><h2 class="accordion-header"><button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#faq5">What payment methods do you accept?</button></h2><div id="faq5" class="accordion-collapse collapse" data-bs-parent="#faqAccordion"><div class="accordion-body mc-body-text">We accept <strong>Cash</strong>, <strong>Bank Transfer</strong>, and <strong>GCash</strong>. Full payment details will be provided by our team upon booking confirmation. Our office is open <strong>Monday–Saturday, 8:00 AM – 5:00 PM</strong> at Trapiche 2, Tanauan City, Batangas.</div></div></div>
          </div>
        </div>
      </div>
    </div>
