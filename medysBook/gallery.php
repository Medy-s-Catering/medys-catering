  ...
  <section class="py-5 mc-section">
    <div class="container">
      ...
      <div class="row g-3">
        ...
        <div class="col-6 col-md-4 col-lg-3 mc-gallery-item" data-category="wedding"><div class="mc-gallery-full-thumb" onclick="openLightbox(this)"><img src="https://images.unsplash.com/photo-1511795409834-ef04bbd61622?w=600&q=80" alt="Wedding Table Setup" data-caption="Elegant Table Setup – Wedding" /><div class="mc-gallery-full-overlay"><i class="bi bi-zoom-in"></i></div></div><p class="small text-center mt-2 mc-body-text">Wedding Setup</p></div>
        <div class="col-6 col-md-4 col-lg-3 mc-gallery-item" data-category="corporate"><div class="mc-gallery-full-thumb" onclick="openLightbox(this)"><img src="https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=600&q=80" alt="Corporate Event" data-caption="Corporate Event – Seminar Catering" /><div class="mc-gallery-full-overlay"><i class="bi bi-zoom-in"></i></div></div><p class="small text-center mt-2 mc-body-text">Corporate Seminar</p></div>
        <div class="col-6 col-md-4 col-lg-3 mc-gallery-item" data-category="corporate"><div class="mc-gallery-full-thumb" onclick="openLightbox(this)"><img src="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80" alt="Corporate Lunch" data-caption="Company Anniversary Dinner" /><div class="mc-gallery-full-overlay"><i class="bi bi-zoom-in"></i></div></div><p class="small text-center mt-2 mc-body-text">Company Anniversary</p></div>
        <div class="col-6 col-md-4 col-lg-3 mc-gallery-item" data-category="birthday"><div class="mc-gallery-full-thumb" onclick="openLightbox(this)"><img src="https://images.unsplash.com/photo-1464349153735-7db50ed83c84?w=600&q=80" alt="Birthday Party" data-caption="Birthday Celebration" /><div class="mc-gallery-full-overlay"><i class="bi bi-zoom-in"></i></div></div><p class="small text-center mt-2 mc-body-text">Birthday Celebration</p></div>
        <div class="col-6 col-md-4 col-lg-3 mc-gallery-item" data-category="birthday"><div class="mc-gallery-full-thumb" onclick="openLightbox(this)"><img src="https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=600&q=80" alt="Debut Party" data-caption="Debut Celebration" /><div class="mc-gallery-full-overlay"><i class="bi bi-zoom-in"></i></div></div><p class="small text-center mt-2 mc-body-text">Debut Party</p></div>
        <div class="col-6 col-md-4 col-lg-3 mc-gallery-item" data-category="school"><div class="mc-gallery-full-thumb" onclick="openLightbox(this)"><img src="https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=600&q=80" alt="Graduation" data-caption="Graduation Ceremony Catering" /><div class="mc-gallery-full-overlay"><i class="bi bi-zoom-in"></i></div></div><p class="small text-center mt-2 mc-body-text">Graduation Reception</p></div>
        <div class="col-6 col-md-4 col-lg-3 mc-gallery-item" data-category="school"><div class="mc-gallery-full-thumb" onclick="openLightbox(this)"><img src="https://images.unsplash.com/photo-1577896851905-b87a5b6d0f83?w=600&q=80" alt="School Event" data-caption="School Recognition Event" /><div class="mc-gallery-full-overlay"><i class="bi bi-zoom-in"></i></div></div><p class="small text-center mt-2 mc-body-text">School Recognition</p></div>
        <div class="col-6 col-md-4 col-lg-3 mc-gallery-item" data-category="food"><div class="mc-gallery-full-thumb" onclick="openLightbox(this)"><img src="https://images.unsplash.com/photo-1555244162-803834f70033?w=600&q=80" alt="Buffet Setup" data-caption="Buffet Spread Setup" /><div class="mc-gallery-full-overlay"><i class="bi bi-zoom-in"></i></div></div><p class="small text-center mt-2 mc-body-text">Buffet Setup</p></div>
        <div class="col-6 col-md-4 col-lg-3 mc-gallery-item" data-category="food"><div class="mc-gallery-full-thumb" onclick="openLightbox(this)"><img src="https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=600&q=80" alt="Food Plating" data-caption="Signature Dishes Display" /><div class="mc-gallery-full-overlay"><i class="bi bi-zoom-in"></i></div></div><p class="small text-center mt-2 mc-body-text">Food Presentation</p></div>
        <div class="col-6 col-md-4 col-lg-3 mc-gallery-item" data-category="food"><div class="mc-gallery-full-thumb" onclick="openLightbox(this)"><img src="https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=600&q=80" alt="Venue Setup" data-caption="Venue Decoration &amp; Setup" /><div class="mc-gallery-full-overlay"><i class="bi bi-zoom-in"></i></div></div><p class="small text-center mt-2 mc-body-text">Venue Decoration</p></div>
        <div class="col-6 col-md-4 col-lg-3 mc-gallery-item" data-category="food"><div class="mc-gallery-full-thumb" onclick="openLightbox(this)"><img src="https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=600&q=80" alt="Dessert Table" data-caption="Dessert Station" /><div class="mc-gallery-full-overlay"><i class="bi bi-zoom-in"></i></div></div><p class="small text-center mt-2 mc-body-text">Dessert Station</p></div>
      </div>
    </div>
  </section>
