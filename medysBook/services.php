  ...
  <section class="py-5 mc-section-alt">
    <div class="container">
      <div class="text-center mb-5">
        ...
        <h2 class="mc-section-title">Sample <span class="mc-accent">Menu</span></h2>
        <p class="mc-body-text mx-auto" style="max-width:500px;">A taste of what we offer. Custom menus are available upon request.</p>
      </div>
      <div class="row g-4">
        <div class="col-md-6"><div class="mc-services-detail"><h5 class="mc-service-title mb-3"><i class="bi bi-journal-text mc-accent me-2"></i>Main Course</h5><div class="mc-menu-item"><span>Lechon Baboy</span><span class="badge bg-danger">Popular</span></div><div class="mc-menu-item"><span>Roasted Chicken with Gravy</span></div><div class="mc-menu-item"><span>Beef Caldereta</span></div><div class="mc-menu-item"><span>Grilled Liempo</span></div><div class="mc-menu-item"><span>Kare-Kare with Bagoong</span></div></div></div>
        <div class="col-md-6"><div class="mc-services-detail"><h5 class="mc-service-title mb-3"><i class="bi bi-journal-text mc-accent me-2"></i>Rice &amp; Pasta</h5><div class="mc-menu-item"><span>Pancit Canton</span><span class="badge bg-danger">Popular</span></div><div class="mc-menu-item"><span>Pancit Bihon</span></div><div class="mc-menu-item"><span>Java Rice</span></div><div class="mc-menu-item"><span>Baked Macaroni</span></div><div class="mc-menu-item"><span>Steamed White Rice</span></div></div></div>
        <div class="col-md-6"><div class="mc-services-detail"><h5 class="mc-service-title mb-3"><i class="bi bi-journal-text mc-accent me-2"></i>Vegetables &amp; Soups</h5><div class="mc-menu-item"><span>Pinakbet</span></div><div class="mc-menu-item"><span>Chopsuey</span></div><div class="mc-menu-item"><span>Sinigang na Baboy</span><span class="badge bg-danger">Popular</span></div><div class="mc-menu-item"><span>Bulalo</span></div><div class="mc-menu-item"><span>Tinolang Manok</span></div></div></div>
        <div class="col-md-6"><div class="mc-services-detail"><h5 class="mc-service-title mb-3"><i class="bi bi-journal-text mc-accent me-2"></i>Desserts &amp; Drinks</h5><div class="mc-menu-item"><span>Leche Flan</span><span class="badge bg-danger">Popular</span></div><div class="mc-menu-item"><span>Buco Pandan Salad</span></div><div class="mc-menu-item"><span>Fruit Salad</span></div><div class="mc-menu-item"><span>Iced Tea &amp; Juice Station</span></div><div class="mc-menu-item"><span>Coffee &amp; Tea Station</span></div></div></div>
      </div>
      <p class="text-center mt-4 mc-body-text"><i class="bi bi-info-circle mc-accent me-1"></i> Menu items may vary depending on the package selected. Contact us for custom menu planning.</p>
    </div>
  </section>
  ...
  <section class="py-5 mc-section">
    <div class="container">
      <div class="text-center mb-5">
        ...
        <p class="mc-body-text mx-auto" style="max-width:500px;">Choose the package that fits your event. All packages can be customized to suit your needs.</p>
      </div>
      <div class="row g-4 justify-content-center">
        <div class="col-md-4"><div class="mc-service-card h-100 text-center"><h5 class="mc-service-title">Basic</h5><div class="display-6 fw-bold mc-accent my-2">₱ [Price]</div><p class="mc-body-text small">Per head / Starting at</p><hr /><ul class="text-start mc-body-text small"><li>5 Main Dishes</li><li>1 Dessert</li><li>Iced Tea</li><li>Table Setup &amp; Utensils</li></ul><a href="booking.php" class="btn mc-btn-outline-red w-100 mt-3">Book This Package</a></div></div>
        <div class="col-md-4"><div class="mc-service-card h-100 text-center border-danger" style="border-width:2px!important;"><div class="badge bg-danger mb-2">Most Popular</div><h5 class="mc-service-title">Standard</h5><div class="display-6 fw-bold mc-accent my-2">₱ [Price]</div><p class="mc-body-text small">Per head / Starting at</p><hr /><ul class="text-start mc-body-text small"><li>8 Main Dishes</li><li>2 Desserts</li><li>Juice &amp; Iced Tea</li><li>Full Table Setup</li><li>Venue Coordination</li></ul><a href="booking.php" class="btn mc-btn-primary w-100 mt-3">Book This Package</a></div></div>
        <div class="col-md-4"><div class="mc-service-card h-100 text-center"><h5 class="mc-service-title">Premium</h5><div class="display-6 fw-bold mc-accent my-2">₱ [Price]</div><p class="mc-body-text small">Per head / Starting at</p><hr /><ul class="text-start mc-body-text small"><li>12+ Main Dishes</li><li>Dessert Station</li><li>Full Drinks Station</li><li>Full Venue Decoration</li><li>Event Coordinator</li><li>Photo-worthy Presentation</li></ul><a href="booking.php" class="btn mc-btn-outline-red w-100 mt-3">Book This Package</a></div></div>
      </div>
    </div>
  </section>
